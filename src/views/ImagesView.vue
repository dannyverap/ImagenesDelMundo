...
onMounted(async () => {
    ...
    images.value = await ImageSearchServiceInstance.searchImages(props!.query, sellerStore.numberOfSellers)
    ...
    <MainLayout>
        ...
        <div class="container my-12 mx-auto px-4 md:px-12">
            <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <template v-else>
                    <ImageCard v-for="(image, idx) in images" :key="idx" :image="image"
