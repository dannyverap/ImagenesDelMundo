...
const email: Ref = ref('test@example.com')
const password: Ref = ref('password')
  ...
  <div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
      ...
      <div class="mt-6 text-center">
        ...
        <RouterLink class="text-primary hover:text-hoverPrimary" :to="{ name: 'signup' }"
          >Sign up</RouterLink
        >
      </div>
      <form @submit.prevent="authUser">
        ...
        <div class="mb-6 text-center">
          ...
          <a
            ...
            class="text-primary mt-2 inline-block hover:text-hoverPrimary"
            >Forgot password?</a
          >
        </div>
      </form>
