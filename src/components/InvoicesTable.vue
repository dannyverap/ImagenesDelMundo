...
<template>
  <div class="text-xl font-semibold mb-4 mt-9 text-center text-textPrimary">Seller's rewards</div>
    ...
    <div class="w-full max-w-5xl overflow-x-auto">
      <table class="min-w-full text-sm text-left rtl:text-right text-gray-700">
        <thead class="text-xs text-textPrimary bg-background uppercase">
          <tr>
            <th scope="col" class="px-3 py-3 w-24">Day</th>
            ...
            <th scope="col" class="px-6 py-3 text-center">Money earn</th>
          </tr>
        </thead>
        ...
        <tfoot v-if="!isLoading">
          <tr class="font-semibold text-textPrimary">
            <th scope="row" class="px-6 py-3 text-base text-left" colspan="2">
              Total Rewards Given
            </th>
